<!-- =====================================================================
     CALIBRAS — Animation JS
     Paste into:  Elementor Pro → Custom Code  (location: </body> – End)
     OR into an HTML widget at the bottom of the page.
     Pure vanilla JS, no dependencies. Safe to run site-wide.
     ===================================================================== -->
<script>
(function () {
  "use strict";
